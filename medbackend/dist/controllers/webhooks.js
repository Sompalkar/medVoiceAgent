...
export async function handlePreCall(req, res) {
    try {
        const body = req.body;
        ...
        const dyn = {
            ...
            emergency_contact: patient.emergencyContactName || ""
        };
...
export async function handleGetPatient(req, res) {
    try {
        const body = req.body;
        ...
        if (sessionId) {
            try {
                await CallLog.findOneAndUpdate({ sessionId }, { $push: { toolResults: { tool: "get-patient", args: { patientId }, dynamicVariables: dyn } } }, { upsert: true });
            }
            catch (e) {
...
export async function handlePostCall(req, res) {
    try {
        const body = req.body;
        const report = body;
        ...
        if (lowerSummary.includes("follow-up") || lowerSummary.includes("follow up"))
            tags.push("followup");
